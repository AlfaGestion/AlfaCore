/*
  ...
  Compatible con SQL Server 2016 (sin STRING_AGG ni sintaxis posterior).
  ...
  con clave (IdBase, WabaId, PhoneNumberId) para aislar tenant/WABA/número -- un webhook de otra
  WABA/número nunca puede tocar la fila de otro.
