...
public sealed class WhatsAppEmbeddedOperationalImportServiceTests
{
        ...
        string currentStep) : IWhatsAppEmbeddedSignupStore
    {
        ...
        public Task MarkActionRequiredAsync(Guid id, WhatsAppEmbeddedActionRequiredReason reason, string summary, string incidentId, string errorCode = "", CancellationToken ct = default) => throw new NotSupportedException();
    ...
    private sealed class MemoryConversacionesConfigService : IConversacionesConfigService
    {
        ...
        public Task<ConversacionWhatsAppConfigDto> GetWhatsAppConfigAsync(int? expectedBaseId, CancellationToken ct = default) => throw new NotSupportedException();
