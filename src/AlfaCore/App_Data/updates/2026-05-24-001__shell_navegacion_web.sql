...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D01', N'/shell/D01', N'ShellWorkspacePage', N'bi-folder2-open', 1, 10, 0, N'Módulo raíz Archivos');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D50', N'/shell/D50', N'ShellWorkspacePage', N'bi-cart-fill', 1, 50, 0, N'Módulo raíz Compras');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D60', N'/shell/D60', N'ShellWorkspacePage', N'bi-graph-up-arrow', 1, 60, 0, N'Módulo raíz Ventas');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D75', N'/shell/D75', N'ShellWorkspacePage', N'bi-bank', 1, 75, 0, N'Módulo raíz Caja y Bancos');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D80', N'/shell/D80', N'ShellWorkspacePage', N'bi-box-seam', 1, 80, 0, N'Módulo raíz Stock');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D95', N'/shell/D95', N'ShellWorkspacePage', N'bi-journal-bookmark-fill', 1, 95, 0, N'Módulo raíz Gestión Contable');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D98', N'/shell/D98', N'ShellWorkspacePage', N'bi-tools', 1, 98, 0, N'Módulo raíz Utilidades');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D010105', N'/clientes', N'Clientes', N'bi-people-fill', 1, 10105, 1, N'ABM web de clientes');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D010110', N'/proveedores', N'ProveedoresMaestro', N'bi-truck', 1, 10110, 1, N'ABM web de proveedores');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D010170', N'/contactos', N'Contactos', N'bi-person-lines-fill', 1, 10170, 1, N'Agenda web de contactos');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D015001', N'/usuarios', N'Usuarios', N'bi-shield-lock-fill', 1, 15001, 0, N'Gestión web de usuarios');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D015003', N'/auditoria', N'Auditoria', N'bi-shield-exclamation', 1, 15003, 0, N'Centro web de auditoría');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D0160', N'/interfaces', N'Interfaces', N'bi-folder2-open', 1, 16000, 1, N'Recepción documental web');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D016001', N'/interfaces/configuracion', N'InterfacesConfiguracion', N'bi-sliders', 1, 16001, 0, N'Configuración web de Interfaces');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D5001', N'/compras/comprobantes', N'Comprobantes', N'bi-receipt', 1, 50010, 0, N'Comprobantes dashboard compras');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D6000', N'/ventas/comprobantes', N'VentasComprobantes', N'bi-receipt', 1, 60000, 0, N'Comprobantes dashboard ventas');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D7510', N'/caja-bancos', N'CajaBancos', N'bi-bank', 1, 75100, 0, N'Dashboard web de caja y bancos');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D8079', N'/stock', N'Stock', N'bi-box-seam', 1, 80790, 0, N'Dashboard web de stock');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D9502', N'/contabilidad', N'Contabilidad', N'bi-journal-bookmark-fill', 1, 95020, 0, N'Dashboard web de contabilidad');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D9808', N'/calendario', N'Calendario', N'bi-calendar3', 1, 98080, 0, N'Calendario web');
END;
...
BEGIN
    INSERT INTO dbo.ALFACORE_MENU_WEB VALUES (@MenuBase, N'D9820', N'/consultas', N'Consultas', N'bi-table', 1, 98200, 1, N'Diseñador de consultas web');
END;
GO
