-- Fix: sp_web_CreaAsientoIngresoEgreso calculaba NUMERO ASIENTO con TIPO_REG='CB'
-- pero escribe TIPO_REG='CJA', causando colisión de números con asientos CBCT.
-- Se cambia el filtro a TIPO_REG='CJA' para que CJA tenga su propia secuencia.
...
-- NUMERO ASIENTO: secuencia propia de CJA (TIPO_REG='CJA') para no colisionar con CBCT (TIPO_REG='CB')
SET @NroAsiento = (
