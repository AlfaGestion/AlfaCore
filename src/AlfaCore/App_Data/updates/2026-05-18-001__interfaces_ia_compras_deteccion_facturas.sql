...
BEGIN
    RAISERROR(N'No existe dbo.INT_COMPROBANTE_RECIBIDO en la base activa.', 16, 1);
    RETURN;
END;

IF OBJECT_ID(N'dbo.INT_COMPROBANTE_RECIBIDO_ADJUNTO', N'U') IS NULL
BEGIN
    RAISERROR(N'No existe dbo.INT_COMPROBANTE_RECIBIDO_ADJUNTO en la base activa.', 16, 1);
    RETURN;
END;
