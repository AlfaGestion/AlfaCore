...
public interface IArcaFacturacionElectronicaService
{
    ...
    Task<ArcaNumeracionPrevistaDto?> ResolverNumeracionAsync(SqlConnection cn, string? uNegocio, string letra, CancellationToken ct);
    ...
    Task<ArcaCaeIntentoDto> SolicitarCaeYPersistirAsync(SqlConnection cn, PuntoVentaCaeContextoDto contexto, CancellationToken ct);
}
