...
public static class WhatsAppEmbeddedSignupStateMachine
{
    private static readonly IReadOnlyDictionary<WhatsAppEmbeddedOnboardingStatus, HashSet<WhatsAppEmbeddedOnboardingStatus>> Allowed =
        new Dictionary<WhatsAppEmbeddedOnboardingStatus, HashSet<WhatsAppEmbeddedOnboardingStatus>>
        {
            ...
            [WhatsAppEmbeddedOnboardingStatus.Importing] = [WhatsAppEmbeddedOnboardingStatus.SyncingHistory, WhatsAppEmbeddedOnboardingStatus.SyncingContacts, WhatsAppEmbeddedOnboardingStatus.Ready, WhatsAppEmbeddedOnboardingStatus.ActionRequired, WhatsAppEmbeddedOnboardingStatus.FailedRetryable, WhatsAppEmbeddedOnboardingStatus.FailedFinal],
            [WhatsAppEmbeddedOnboardingStatus.SyncingHistory] = [WhatsAppEmbeddedOnboardingStatus.SyncingContacts, WhatsAppEmbeddedOnboardingStatus.Ready, WhatsAppEmbeddedOnboardingStatus.FailedRetryable, WhatsAppEmbeddedOnboardingStatus.FailedFinal],
            [WhatsAppEmbeddedOnboardingStatus.SyncingContacts] = [WhatsAppEmbeddedOnboardingStatus.Ready, WhatsAppEmbeddedOnboardingStatus.FailedRetryable, WhatsAppEmbeddedOnboardingStatus.FailedFinal],
            [WhatsAppEmbeddedOnboardingStatus.FailedRetryable] = [WhatsAppEmbeddedOnboardingStatus.Authorized, WhatsAppEmbeddedOnboardingStatus.DiscoveringAssets, WhatsAppEmbeddedOnboardingStatus.ValidatingOwnership, WhatsAppEmbeddedOnboardingStatus.ConfiguringAccess, WhatsAppEmbeddedOnboardingStatus.SubscribingWabas, WhatsAppEmbeddedOnboardingStatus.CheckingCustomerPayment, WhatsAppEmbeddedOnboardingStatus.DiscoveringPhones, WhatsAppEmbeddedOnboardingStatus.RegisteringPhones, WhatsAppEmbeddedOnboardingStatus.Importing, WhatsAppEmbeddedOnboardingStatus.SyncingHistory, WhatsAppEmbeddedOnboardingStatus.SyncingContacts, WhatsAppEmbeddedOnboardingStatus.FailedFinal, WhatsAppEmbeddedOnboardingStatus.Expired],
            // Cancelled: salida de UX "Cancelar configuración" (CancelActionRequiredAsync) para
            // abandonar explícitamente una configuración incompleta -- no toca ownership/Vault/Meta.
            [WhatsAppEmbeddedOnboardingStatus.ActionRequired] = [WhatsAppEmbeddedOnboardingStatus.Authorized, WhatsAppEmbeddedOnboardingStatus.CheckingCustomerPayment, WhatsAppEmbeddedOnboardingStatus.DiscoveringPhones, WhatsAppEmbeddedOnboardingStatus.FailedFinal, WhatsAppEmbeddedOnboardingStatus.Expired, WhatsAppEmbeddedOnboardingStatus.Cancelled]
        };
